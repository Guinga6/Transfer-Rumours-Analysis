...
videos = get_youtube_videos(channel_url="https://www.youtube.com/@FabrizioRomanoYT",start_results=0,end_results=1)
...
for video in videos:
    try:
        ...
        text = audio_to_text(audio_path=video['title']+'.mp3')
